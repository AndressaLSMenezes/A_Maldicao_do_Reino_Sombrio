...
class Game:
    ...
    def draw_background (self):
        ...
        self.scrreen.blit(BG, (image_width + self.x_pos_bg, self.y_pos_bg))
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            draw_message_component("Precione qualquer tecla para reiniciar o jogo", self.screen, pos_y_center=half_screen_height + 140)   
            draw_message_component(
